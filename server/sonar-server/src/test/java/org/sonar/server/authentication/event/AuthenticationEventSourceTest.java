...
public class AuthenticationEventSourceTest {
  ...
  @Test
  public void localCsrf_returns_source_instance_with_hardcoded_method_provider_and_providerName() {
    Source underTest = Source.localCsrf();

    assertThat(underTest.getMethod()).isEqualTo(Method.CSRF);
    assertThat(underTest.getProvider()).isEqualTo(Provider.LOCAL);
    assertThat(underTest.getProviderName()).isEqualTo("local");

    assertThat(underTest).isSameAs(Source.localCsrf());
  }
  ...
  public void source_implements_equals_on_all_fields() {
    ...
    assertThat(Source.sso()).isNotEqualTo(Source.localCsrf());
    assertThat(Source.localCsrf()).isEqualTo(Source.localCsrf());
    ...
    assertThat(Source.local(Method.BASIC)).isNotEqualTo(Source.localCsrf());
